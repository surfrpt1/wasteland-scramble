...
export const JUNKYARD_MAP = {
    ...
    decor: [
        ...
        // Fuller grass coverage across the map
        { x: 6 * T, type: 'grass_bush' },
        { x: 14 * T, type: 'grass_bush' },
        { x: 20 * T, type: 'grass_tuft' },
        { x: 22 * T, type: 'grass_bush' },
        { x: 28 * T, type: 'grass_tuft' },
        { x: 30 * T, type: 'grass_bush' },
        { x: 37 * T, type: 'grass_tuft' },
        { x: 39 * T, type: 'grass_bush' },
        { x: 42 * T, type: 'grass_tuft' },
        { x: 46 * T, type: 'grass_bush' },
        { x: 48 * T, type: 'grass_tuft' },
        { x: 53 * T, type: 'grass_bush' },
        { x: 55 * T, type: 'grass_tuft' },
        { x: 58 * T, type: 'grass_bush' },
        { x: 62 * T, type: 'grass_tuft' },
        { x: 64 * T, type: 'grass_bush' },
        { x: 66 * T, type: 'grass_tuft' },
        { x: 72 * T, type: 'grass_bush' },
        { x: 74 * T, type: 'grass_tuft' },
        { x: 78 * T, type: 'grass_bush' },
    ],
    radZones: [
        { x: 36, y: 22, w: 8, h: 5 },
        { x: 60, y: 9, w: 6, h: 3 },
